public class App {
	public static void main(String[] args) {
		...
		// static 변수는 객체 생성없이
		// 클래스명.변수명으로 언제든지 사용가능
		
		System.out.println(A.y);  //static 멤버는 클래스명.변수 클래스명.메소드()형식으로 사용
								//로딩되는 순간 static영역에 변수를 생성
		...
		//System.out.println(a1.y); //y가 멤버변수 처럼 인실될 수 있으므로 출력이 되긴 하나 잘못된 표식

public class StringDemo {
	public static void main(String[] args) {
		...
		/*
			String 클래스
				...
				String은 객체를 생성하는 특별한 방법을 제공한다. 
					...
					String str = "abc";					// 문자열 표현식을 이요한 String 객체 생성
		...
		*/
		...
		// 문자열이 지정한 문자열을 포함하고 있느지 여부를 반환하는 메소드: boolean contains(CharSequence s)
